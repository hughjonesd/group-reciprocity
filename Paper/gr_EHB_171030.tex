...
{\centering \includegraphics[width=6in,height=4in]{figure/simulations-1} 

}

\caption[Simulation results]{Simulation results. $b$ = benefit of being helped. $n$ = group size.}\label{fig:simulations}
\end{figure}
