...
# TODO: 
# 1. Why would group-based upstream reciprocity be important for the evolution of human behavior?  How does this contribute
# to current debates in the literature about the evolution of human behavior?
# 5. The findings should be qualified with a
# discussion of potential cross-cultural variation in how perceived intentions affect moral judgment (see Barrett et al.
# 2016).  Do you expect the difference in group reciprocity between senders and responders to hold across all human
# groups? 
# 6. You should very clearly state your theoretical expectations for the analyses in the introduction (including
# the analysis of social value orientation).  And if you are going to present the SVO results, then you should devote
# more time to why you expected SVO would matter, and also how SVO is related to the different behaviors and outcome sin
# the game. 7. As a point of comparison, it would be helpful to include the same figures as in Figure 2, but for
# allocations in the direct reciprocity situation.
@
...
% 1. Why would group-based upstream reciprocity be important for the evolution of human behavior?  
% How does this contribute
% to current debates in the literature about the evolution of human behavior?
% here's my first shot, is it too speculative? Could we back it up?
% in particular, do existing models explain how IG conflict arises? I have the impression that in some models it just 
% "turns up" exogenously.
