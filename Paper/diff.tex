...
\DIFdelbegin \DIFdel{There are three kinds of theories of }\DIFdelend \DIFaddbegin \begin{figure}
	\begin{center}
        ...
        \begin{subfigure}[b]{0.4\textwidth}
		  \includegraphics[width=\textwidth]{group.pdf}
            \caption{}\label{group}
        \end{subfigure}
        \caption{\DIFaddFL{Upstream reciprocity. (\textit{a}) Someone who was helped or harmed becomes more likely to help or harm others. (\textit{b})
...
\DIFadd{The current literature includes three differing approaches to understanding }\DIFaddend the evolution of intergroup \DIFdelbegin \DIFdel{violence. Cultural theories argue }\DIFdelend \DIFaddbegin \DIFadd{conflict. Group reciprocity provides an additional component, illuminating---and to an extent bridging---the different approaches.
%DIF > There are three kinds of theories of the evolution of intergroup violence.
While cultural theories argue that }\DIFaddend there is no innate tendency to intergroup aggression\DIFdelbegin \DIFdel{. Parochial altruism theories }\DIFdelend \DIFaddbegin \DIFadd{, theories of arochial altruism }\DIFaddend argue that intergroup violence was a driver of within-group altruism \DIFdelbegin \DIFdel{, }\DIFdelend via group selection \DIFaddbegin \DIFadd{processes}\DIFaddend ; as a result, intergroup violence can involve self-sacrifice for one's group
members \citep{choi2007coevolution,bowles2009did}. The \DIFdelbegin \DIFdel{"}\DIFdelend chimpanzee model", by contrast, argues that early humans, like chimpanzees, only attack when odds are very favourable; thus conflict is sufficiently motivated by self-interest 
...
\DIFaddbegin \DIFadd{We argue that group reciprocity can evolve in an environment where attacks are motivated by self interest, and provides a check for intergroup violence. }\DIFaddend Paradoxically, group \DIFdelbegin \DIFdel{reciprocity could }\DIFdelend \DIFaddbegin \DIFadd{reciprocity---while having the potential to expand the circle of violence---could }\DIFaddend explain the rarity of conflict among \DIFdelbegin \DIFdel{hunter-gatherers}\DIFdelend \DIFaddbegin \DIFadd{hunter-gather}\-\DIFadd{ers}\DIFaddend .
...
chimpanzees do practice retaliation and reconciliation among alliances within the band, they  do not reciprocate towards other bands. Instead, they \DIFdelbegin \DIFdel{always }\DIFdelend attack stranger chimpanzees \DIFdelbegin \DIFdel{, when }\DIFdelend \DIFaddbegin \DIFadd{whenever }\DIFaddend it is safe to do so. The risk of being attacked forces chimps to avoid territory bordering other bands, which limits their available space for foraging \citep{wilson2003intergroup}. Thus, the evolution of group reciprocity could have benefited humans by allowing them to range over wider areas and to have more extensive contacts with outgroups. \citet{kelly2000warless} argues that group reciprocity (\DIFdelbegin \DIFdel{"}\DIFdelend \DIFaddbegin \DIFadd{``}\DIFaddend social substitutability") is more important when there is a strong political clan organization; however, hunter-gatherers do sometimes practice group reciprocity \citep{boehm2012ancestral}.

While group reciprocity can benefit the group, to evolve it must increase individual fitness. \DIFdelbegin \DIFdel{In the appendix we 
run simulations showing how this can happen. 
}\DIFdelend \DIFaddbegin \DIFadd{We suggest that group reciprocity gives rise to group reputation, allowing for group-level selection. The environment is the following. 
%DIF > In the appendix we run simulations showing how this can happen. 
}\DIFaddend Individuals are divided into groups of size $n$. \DIFdelbegin \DIFdel{They are either selfish 
or group reciprocal types. Each 
}\DIFdelend \DIFaddbegin \DIFadd{In each }\DIFaddend period, each individual has an opportunity to help or harm a randomly chosen outgroup member. Helping has a fitness cost\DIFaddbegin \DIFadd{~}\DIFaddend $c$ while providing a benefit\DIFaddbegin \DIFadd{~}\DIFaddend $b$ to the target \DIFdelbegin \DIFdel{. }\DIFdelend \DIFaddbegin \DIFadd{(alternatively, $c$ can be viewed as the benefit to the actor from exploiting the interaction partner, thereby imposing on them a harm of~$b$). 
Individual strategies are of two types: selfish or group reciprocal types.
}\DIFaddend Selfish types never help, while group reciprocators help in \DIFdelbegin \DIFdel{the first instance}\DIFdelend \DIFaddbegin \DIFadd{their first interactions}\DIFaddend , and then help with a probability proportional to the number of times they have been helped before by \DIFdelbegin \DIFdel{a }\DIFdelend \DIFaddbegin \DIFadd{any }\DIFaddend member of the \DIFdelbegin \DIFdel{outgroup. 
}\DIFdelend \DIFaddbegin \DIFadd{group of their current interaction partner. 
}

\DIFadd{Groups with a high share of group reciprocators learn over time to cooperate with each other while maintaining a hostile relationship with groups that have a high share of selfish types. Selfish types in cooperative groups free ride on the group reputation, exploiting members of other cooperating groups, thereby gaining higher fitness then the group reciprocators in their group. Nonetheless, if the share of group reciprocators within the group varies sufficiently between groups, group reciprocators are overrepresented in the cooperative groups, and therefore have higher fitness overall (this structure, where group reciprocators have higher fitness overall despite having lower fitness within each group mirrors the well-known Simpson paradox).
}

\DIFadd{In the supplementary materials, we report on a series of simulations tracking the evolution of group reciprocators under different environmental parameters. }\DIFaddend We show that group reciprocity can evolve to fixation if $b/c > n$; that is, it is a public good within the group. The high $b/c$ ratio required for group reciprocity to evolve fits the \DIFdelbegin \DIFdel{"}\DIFdelend \DIFaddbegin \DIFadd{``}\DIFaddend chimpanzee model" of conflict where attacks are only launched if it is low risk. This may also explain why most salient examples of group reciprocity are seen in the \DIFdelbegin \DIFdel{"}\DIFdelend \DIFaddbegin \DIFadd{``}\DIFaddend negative" domain of harm and conflict. When $b/c$ is high, hurting or refraining from helping is a \DIFdelbegin \DIFdel{"}\DIFdelend \DIFaddbegin \DIFadd{``}\DIFaddend nasty" thing to do, since it imposes a large loss on the target for a small gain to oneself.

\DIFdelbegin \DIFdel{Group reciprocity provides an evolutionary basis for outgroup stereotyping. Upstream group reciprocity
...
}\DIFdelend %DIF >  WITH THE NEW FOCUS ON THE EVOLUTIONARY PROCESS, I THINK THE NEXT PARAGRAPH HAS NO PLACE

\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD < 	\begin{center}
%DIFDELCMD <         \begin{subfigure}[b]{0.4\textwidth}
%DIFDELCMD < 		  \includegraphics[width=\textwidth]{upstream.pdf}
%DIFDELCMD <             %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
}%DIFAUXCMD
%DIFDELCMD < \label{upstream}
%DIFDELCMD <         \end{subfigure}
%DIFDELCMD <         \qquad
%DIFDELCMD <         \begin{subfigure}[b]{0.4\textwidth}
%DIFDELCMD < 		  \includegraphics[width=\textwidth]{group.pdf}
%DIFDELCMD <             %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
}%DIFAUXCMD
%DIFDELCMD < \label{group}
%DIFDELCMD <         \end{subfigure}
%DIFDELCMD <         %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdel{Upstream reciprocity. (\textit{a}) Someone who was helped or harmed becomes more likely to help or harm others. (\textit{b})
    Upstream group reciprocity targets people who belong to
    the same group as the initial partner.}}
        %DIFAUXCMD
...
%DIFDELCMD < %%%
\DIFdelend %DIF > Group reciprocity provides an evolutionary basis for outgroup stereotyping. Upstream group reciprocity has different cognitive requirements from related phenomena. While ingroup altruism and group-based downstream reciprocity require people to differentiate their own group from outsiders---``us'' from ``them''---upstream group  reciprocity requires them to differentiate between different outgroups---between ``them and them''---and to keep a mental account of outgroups' reputation. 

% should cite
\DIFdelbegin \DIFdel{We ran a laboratory experiment to test the hypothesis that people }\DIFdelend \DIFaddbegin 

\DIFadd{Thus, we hypothesise that humans developed a proclavity to }\DIFaddend reciprocate towards groups. Although field observations from conflict are highly suggestive, they are loaded with individual and group context and history. \DIFdelbegin \DIFdel{Observing group reciprocity under controlled laboratory conditions with artifical groupsidentifies group reciprocity as an innate human tendency. 
}\DIFdelend \DIFaddbegin \DIFadd{Moreover, in the natural world it is difficult to distinguish between retaliatory acts directed at groups that include the perpetrator and acts directed at unrelated group members.  %DIF > Observing group reciprocity under controlled laboratory conditions with artifical groups identifies group reciprocity as an innate human tendency.
...
\DIFaddend Group reciprocity, however, is only observed for senders, who allocate
...
%DIFDELCMD < \definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{figure}
%DIFDELCMD < \includegraphics[width=\maxwidth]{figure/plots-1} %%%
%DIFDELCMD < \caption[Allocations in the Group Reciprocity condition versus the TG experience]{%
{%DIFAUXCMD
\DIFdel{Allocations in the Group Reciprocity condition versus the TG experience. Circles show individual data points (circle size proportional to number of observations). Lines show linear regressions.}}%DIFAUXCMD
%DIFDELCMD < \label{fig:plots}
%DIFDELCMD < \end{figure}
%DIFDELCMD < 
...
in that specific outgroup. This supports the argument of \DIFdelbegin %DIFDELCMD < \cite{Pietraszewski2016470} %%%
\DIFdelend \DIFaddbegin \citet{Pietraszewski2016470} \DIFaddend that group identity can modify the cost-benefit calculus of individuals deciding whether to extend a conflict. Unlike parochial altruism and within-group reciprocity, group reciprocity requires humans to differentiate between outgroups, possibly providing a cognitive basis for intergroup stereotyping and prejudice.
...
therefore other Blue members did not send money' is not---as, given subjects' knowledge, the other Blue members \DIFdelbegin \DIFdel{were not even necessarily senders}\DIFdelend \DIFaddbegin \DIFadd{may not even had the opportunity to send any money}\DIFaddend .
...
may provide another piece of the puzzle, as it \DIFdelbegin \DIFdel{provides two new channels
by which upstream }\DIFdelend \DIFaddbegin \DIFadd{allows upstream reciprocity to direct group-level selection in ways parallel to those by which direct reciprocity direct individual-level selection.
%DIF > provides two new channels by which upstream reciprocity may evolve. 
We acknowledge, though not develop here, two other ways by which group }\DIFaddend reciprocity may evolve.
First, group members are interdependent, especially in the small groups that were the norm during most of human evolutionary history. Punishing a perpetrator's group member therefore indirectly harms the perpetrator, who is dependent on his peers for, e.g., public goods provision. Thus, group reciprocity may bridge upstream indirect reciprocity and direct reciprocity \DIFaddbegin \DIFadd{through intra-group dependencies}\DIFaddend .
...
organised in groups, such that \DIFdelbegin \DIFdel{people }\DIFdelend \DIFaddbegin \DIFadd{individuals }\DIFaddend interact more frequently with
