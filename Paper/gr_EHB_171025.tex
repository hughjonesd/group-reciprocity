...
In this context it is important to understand the propensity for group reciprocity. Is it intrinsically linked to a type
of social organization -- segmented societies with collective responsibility for revenge and collective liability of
perpetrator group? Or is it a more general human capacity that may be activated in different contexts? We try to answer
this question experimentally, by testing for group reciprocity in a modern society, where collective responsibility for 
revenge is not socially accepted. 
...
\textbf{This para needs some tweaking:}

In the discussion above we argue that humans developed a propensity to reciprocate towards groups, which we aim to study empirically. Although field observations from conflict are highly suggestive, they are loaded with individual and group context and history. Moreover, in the natural world it is difficult to distinguish between retaliatory acts directed at groups that include the perpetrator and acts directed at unrelated group members. We therefore designed a controlled laboratory experiment to test the proximate psychological mechanism by which humans reciprocate towards groups in a clean way. 
...
% and the role of intentions (or perceptions thereof). 

% 
% It is
% possible that humans generalize \emph{intentions} across group members more than they generalize
% \emph{actions} across group members. So, if (e.g.)  group member 1 wishes to harm them,  they are prone to infer
