...
\newcommand{\signature}[1]{%
 \par\parbox[t]{0.6\textwidth}\quad#1\par}
...
Nevertheless, we tested our results for robustness to repeated encounters effects in two ways. First we reran the regressions of table 2, including a dummy variable for having encountered the same participant before. This was significant for regressions on amount given by senders to recipients only. The main results were qualitatively unchanged, as follows:
