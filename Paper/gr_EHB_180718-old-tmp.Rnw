...
play in the trust game, suggesting that group reciprocity was only triggered by strong norm violations. We show conditions under which group 
...
\citep{tajfel1979integrative,yamagishi2000thegroup,balliet2014ingroup,DeDreu2014,chen2009group,chen2011potential}.
 provides the backdrop for intergroup conflict---from economic
...
\emph{their} tribe have done to me' (Figure~\ref{fig:illustration}). Tit-for-tat conflict looks like negative group reciprocity, i.e., reciprocity where harm is reciprocated with harm.
...
altruism via group selection; as a result, intergroup violence can involve self-sacrifice for one's group
...
\citep{boehm1984blood,fearon1996explaining}. Group reciprocity could thus have benefited humans by allowing them to exploit more of the land area 
...
suggest there may be a universal propensity to group-reciprocate. 
\end{comment}
